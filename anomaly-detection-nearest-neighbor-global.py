...
def main():
    ...
    listFeatures = ["eventType", "entitySize", "componentId", "durationMillis", "lineageDuration"]
    ...
    indexingTime = time.time() - start_time
    ...
    print "Time to train with indexing:", time.time() - start_time
    print "Time to train without indexing:", time.time() - start_time - indexingTime
    plt.figure()
    ...
    plt.title('ROC 20-50ms anomalies')
