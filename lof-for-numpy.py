...
# remove array modified to avoid ValueError
# LOF instance modified to not normalize
def outliers(k, instances, **kwargs):
    ...
    for i, instance in enumerate(instances_value_backup):
        ...
        removeArray(instances, instance)
        l = LOF(instances, normalize=False, **kwargs)
...
# to address "ValueError: The truth value of an array with more than one element is ambiguous. Use a.any() or a.all()" when using remove()
