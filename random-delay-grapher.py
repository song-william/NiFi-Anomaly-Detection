...
def main():
    ...
    listFeatures = ["entitySize", "durationMillis", "componentId", "eventType"]
    ...
    plt.show()
    """classes = ['LogAttribute', 'GenerateFlowFile', 'ExecuteScript']
    class_colours = ['blue', 'green', 'red']
    use_colours = dict(zip(classes, class_colours))
    use_sizes = {0: 10, 1: 50}
    use_markers = {0: 'o', 1: 'x'}
    fig = plt.figure()
